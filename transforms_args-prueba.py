...
from transforms import *  # Importa todas las funciones del módulo transforms
...
def main():
    try:
        ...
        elif cambios == 'change_colors':  # Tiene 6 parámetros
            if len(sys.argv) < 5:
